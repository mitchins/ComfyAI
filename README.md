...
Clone this repo into the `custom_nodes/` directory of your ComfyUI install and
...
Install the optional dependencies and launch the packaged server if you want a
lightweight OpenAI compatible endpoint.
